...
class RoomsGameViewController: GameGameViewController, GameDelegate, RoomsMixin {
    ...
    func startGame() {
        ...
        game = RoomsGame(layout: layout, delegate: self)
    ...
    func updateMovesUI(_ game: RoomsGame) {
