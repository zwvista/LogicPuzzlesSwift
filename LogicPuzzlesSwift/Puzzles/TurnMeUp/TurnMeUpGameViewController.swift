//
//  TurnMeUpGameViewController.swift
//  LogicPuzzlesSwift
//
...
class TurnMeUpGameViewController: GameGameViewController2<TurnMeUpGameState, TurnMeUpGame, TurnMeUpDocument, TurnMeUpGameScene> {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = TurnMeUpGameMove(p: p, dir: dir)
    ...
    override func handlePan(_ sender: UIPanGestureRecognizer) {
        ...
        case .changed:
            ...
            var move = TurnMeUpGameMove(p: pLast!, dir: dir)
    ...
    override func newGame(level: GameLevel) -> TurnMeUpGame {
        TurnMeUpGame(layout: level.layout, delegate: self)
    }
}
