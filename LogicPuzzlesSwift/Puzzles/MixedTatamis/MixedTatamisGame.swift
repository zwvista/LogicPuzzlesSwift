...
class MixedTatamisGame: GridGame<MixedTatamisGameState> {
    ...
    init(layout: [String], delegate: MixedTatamisGameViewController? = nil) {
        ...
        let state = MixedTatamisGameState(game: self)
