...
class MineShipsMainViewController: MainViewController, MineShipsMixin {
    ...
    @IBAction func resumGame(_ sender: AnyObject) {
        ...
        let gameViewController = self.storyboard!.instantiateViewController(withIdentifier: "MineShipsGameViewController") as! MineShipsGameViewController
