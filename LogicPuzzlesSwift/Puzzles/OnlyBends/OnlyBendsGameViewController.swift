//
//  OnlyBendsGameViewController.swift
//  LogicPuzzlesSwift
//
...
class OnlyBendsGameViewController: GameGameViewController2<OnlyBendsGameState, OnlyBendsGame, OnlyBendsDocument, OnlyBendsGameScene> {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = OnlyBendsGameMove(p: p, dir: dir)
    ...
    override func newGame(level: GameLevel) -> OnlyBendsGame {
        OnlyBendsGame(layout: level.layout, delegate: self)
    }
}
