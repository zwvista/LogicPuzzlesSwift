...
class MiniLitsGameViewController: GameGameViewController, GameDelegate {
    ...
    override func startGame() {
        ...
        game = MiniLitsGame(layout: level.layout, elemLevel: level.elemLevel, delegate: self)
    ...
    func moveAdded(_ game: AnyObject, move: MiniLitsGameMove) {
    ...
    func levelUpdated(_ game: AnyObject, from stateFrom: MiniLitsGameState, to stateTo: MiniLitsGameState) {
        let game = game as! MiniLitsGame
        updateMovesUI(game)
        guard !levelInitilizing else {return}
