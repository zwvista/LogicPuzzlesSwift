//
//  TraceNumbersGameViewController.swift
//  LogicPuzzlesSwift
//
...
class TraceNumbersGameViewController: GameGameViewController2<TraceNumbersGameState, TraceNumbersGame, TraceNumbersDocument, TraceNumbersGameScene> {
    ...
    override func newGame(level: GameLevel) -> TraceNumbersGame {
        TraceNumbersGame(layout: level.layout, delegate: self)
    }
}
