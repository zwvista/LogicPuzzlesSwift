//
//  AssemblyInstructionsGameScene.swift
//  LogicPuzzlesSwift
//
...
class AssemblyInstructionsGameScene: GameScene<AssemblyInstructionsGameState> {
    var gridNode: AssemblyInstructionsGridNode {
        get { getGridNode() as! AssemblyInstructionsGridNode }
    ...
    override func levelInitialized(_ game: AnyObject, state: AssemblyInstructionsGameState, skView: SKView) {
        let game = game as! AssemblyInstructionsGame
        removeAllChildren()
    ...
    override func levelUpdated(from stateFrom: AssemblyInstructionsGameState, to stateTo: AssemblyInstructionsGameState) {
