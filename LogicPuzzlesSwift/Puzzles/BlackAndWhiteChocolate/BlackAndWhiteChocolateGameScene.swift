//
//  BlackAndWhiteChocolateGameScene.swift
//  LogicPuzzlesSwift
//
...
class BlackAndWhiteChocolateGameScene: GameScene<BlackAndWhiteChocolateGameState> {
    var gridNode: BlackAndWhiteChocolateGridNode {
        get { getGridNode() as! BlackAndWhiteChocolateGridNode }
    ...
    override func levelInitialized(_ game: AnyObject, state: BlackAndWhiteChocolateGameState, skView: SKView) {
        let game = game as! BlackAndWhiteChocolateGame
        removeAllChildren()
    ...
    override func levelUpdated(from stateFrom: BlackAndWhiteChocolateGameState, to stateTo: BlackAndWhiteChocolateGameState) {
