//
//  BlackAndWhiteChocolateGame.swift
//  LogicPuzzlesSwift
//
...
class BlackAndWhiteChocolateGame: GridGame<BlackAndWhiteChocolateGameState> {
    ...
    init(layout: [String], delegate: BlackAndWhiteChocolateGameViewController? = nil) {
        ...
        let state = BlackAndWhiteChocolateGameState(game: self)
