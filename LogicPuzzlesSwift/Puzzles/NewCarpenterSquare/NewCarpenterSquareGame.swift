...
class NewCarpenterSquareGame: GridGame<NewCarpenterSquareGameState> {
    ...
    var pos2hint = [Position: NewCarpenterSquareHint]()
    var objArray = [GridDotObject]()

    init(layout: [String], delegate: NewCarpenterSquareGameViewController? = nil) {
        ...
        let state = NewCarpenterSquareGameState(game: self)
