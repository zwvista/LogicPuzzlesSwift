...
class TentsGame: CellsGame<TentsGameViewController, TentsGameMove, TentsGameState>, GameBase {
    static let gameID = "Tents"
    static let offset = [
        Position(-1, 0),
        Position(0, 1),
        Position(1, 0),
    ...
    private func changeObject(move: inout TentsGameMove, f: (inout TentsGameState, inout TentsGameMove) -> Bool) -> Bool {
        if canRedo {
