...
class GalaxiesGameState: GridGameState<GalaxiesGameMove> {
    ...
    override func setObject(move: inout GalaxiesGameMove) -> GameOperationType {
        var changed = false
    ...
    override func switchObject(move: inout GalaxiesGameMove) -> GameOperationType {
