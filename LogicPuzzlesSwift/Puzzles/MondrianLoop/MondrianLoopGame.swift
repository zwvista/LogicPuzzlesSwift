...
class MondrianLoopGame: GridGame<MondrianLoopGameState> {
    ...
    init(layout: [String], delegate: MondrianLoopGameViewController? = nil) {
        ...
        let state = MondrianLoopGameState(game: self)
