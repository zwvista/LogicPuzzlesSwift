...
class MosaikOptionsViewController: OptionsViewController, MosaikMixin {
    ...
    func updateMarkerOption() {
        lblMarkerOption.text = MosaikMarkerOptions.optionStrings[markerOption]
    }
    ...
    override func onDefault() {
        ...
        setMarkerOption(MosaikMarkerOptions.noMarker.rawValue)
        rec.commit()
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        ActionSheetStringPicker.show(withTitle: "Marker Options", rows: MosaikMarkerOptions.optionStrings, initialSelection: markerOption, doneBlock: { (picker, selectedIndex, selectedValue) in
