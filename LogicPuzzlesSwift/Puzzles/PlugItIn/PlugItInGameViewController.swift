//
//  PlugItInGameViewController.swift
//  LogicPuzzlesSwift
//
...
class PlugItInGameViewController: GameGameViewController2<PlugItInGameState, PlugItInGame, PlugItInDocument, PlugItInGameScene> {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = PlugItInGameMove(p: p, dir: dir)
    ...
    override func newGame(level: GameLevel) -> PlugItInGame {
        PlugItInGame(layout: level.layout, delegate: self)
    }
}
