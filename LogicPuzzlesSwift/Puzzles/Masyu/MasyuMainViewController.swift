...
class MasyuMainViewController: MainViewController, MasyuMixin {
    ...
    @IBAction func resumGame(_ sender: AnyObject) {
        ...
        let gameViewController = self.storyboard!.instantiateViewController(withIdentifier: "MasyuGameViewController") as! MasyuGameViewController
