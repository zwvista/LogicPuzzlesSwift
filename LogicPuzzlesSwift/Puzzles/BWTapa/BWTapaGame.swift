...
class BWTapaGame: GridGame<BWTapaGameViewController> {
    static let offset = [
        Position(-1, 0),
        Position(-1, 1),
        Position(0, 1),
    ...
    private func changeObject(move: inout BWTapaGameMove, f: (inout BWTapaGameState, inout BWTapaGameMove) -> Bool) -> Bool {
        if canRedo {
