...
class RippleEffectGame: GridGame<RippleEffectGameViewController> {
    ...
    init(layout: [String], delegate: RippleEffectGameViewController? = nil) {
    ...
    private func changeObject(move: inout RippleEffectGameMove, f: (inout RippleEffectGameState, inout RippleEffectGameMove) -> Bool) -> Bool {
        if canRedo {
