//
//  BotanicalParkGameViewController.swift
//  LogicPuzzlesSwift
//
...
class BotanicalParkGameViewController: GameGameViewController2<BotanicalParkGameState, BotanicalParkGame, BotanicalParkDocument, BotanicalParkGameScene> {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = BotanicalParkGameMove(p: p)
