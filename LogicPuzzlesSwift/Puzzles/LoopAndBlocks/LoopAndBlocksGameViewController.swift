//
//  LoopAndBlocksGameViewController.swift
//  LogicPuzzlesSwift
//
...
class LoopAndBlocksGameViewController: GameGameViewController2<LoopAndBlocksGameState, LoopAndBlocksGame, LoopAndBlocksDocument, LoopAndBlocksGameScene> {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = LoopAndBlocksGameMove(p: p, dir: dir)
    ...
    override func handlePan(_ sender: UIPanGestureRecognizer) {
        ...
        case .changed:
            ...
            var move = LoopAndBlocksGameMove(p: pLast!, dir: dir)
