//
//  OnlyStraightsGameViewController.swift
//  LogicPuzzlesSwift
//
...
class OnlyStraightsGameViewController: GameGameViewController2<OnlyStraightsGameState, OnlyStraightsGame, OnlyStraightsDocument, OnlyStraightsGameScene> {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = OnlyStraightsGameMove(p: p, dir: dir)
    ...
    override func handlePan(_ sender: UIPanGestureRecognizer) {
        ...
        case .changed:
            ...
            var move = OnlyStraightsGameMove(p: pLast!, dir: dir)
    ...
    override func newGame(level: GameLevel) -> OnlyStraightsGame {
        OnlyStraightsGame(layout: level.layout, delegate: self)
    }
}
