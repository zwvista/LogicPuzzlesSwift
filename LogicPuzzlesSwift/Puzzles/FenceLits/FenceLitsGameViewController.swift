//
//  FenceLitsGameViewController.swift
//  LogicPuzzlesSwift
//
...
class FenceLitsGameViewController: GameGameViewController, GameDelegate, FenceLitsMixin {
    ...
    override func viewDidLoad() {
        ...
        scene = FenceLitsGameScene(size: skView.bounds.size)
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        guard b else {return}
        var move = FenceLitsGameMove(p: p, dir: dir, obj: .empty)
    ...
    func startGame() {
        ...
        game = FenceLitsGame(layout: layout, delegate: self)
    ...
    func moveAdded(_ game: AnyObject, move: FenceLitsGameMove) {
        guard !levelInitilizing else {return}
        gameDocument.moveAdded(game: game, move: move)
    }
    
    func updateMovesUI(_ game: FenceLitsGame) {
    ...
    func levelInitilized(_ game: AnyObject, state: FenceLitsGameState) {
        let game = game as! FenceLitsGame
        updateMovesUI(game)
        scene.levelInitialized(game, state: state, skView: skView)
    }
    
    func levelUpdated(_ game: AnyObject, from stateFrom: FenceLitsGameState, to stateTo: FenceLitsGameState) {
        let game = game as! FenceLitsGame
        updateMovesUI(game)
        guard !levelInitilizing else {return}
