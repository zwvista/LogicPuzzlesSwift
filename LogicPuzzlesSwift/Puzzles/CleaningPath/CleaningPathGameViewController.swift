//
//  CleaningPathGameViewController.swift
//  LogicPuzzlesSwift
//
...
class CleaningPathGameViewController: GameGameViewController2<CleaningPathGameState, CleaningPathGame, CleaningPathDocument, CleaningPathGameScene> {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = CleaningPathGameMove(p: p, dir: dir)
    ...
    override func handlePan(_ sender: UIPanGestureRecognizer) {
        ...
        case .changed:
            ...
            var move = CleaningPathGameMove(p: pLast!, dir: dir)
    ...
    override func newGame(level: GameLevel) -> CleaningPathGame {
        CleaningPathGame(layout: level.layout, delegate: self)
    }
}
