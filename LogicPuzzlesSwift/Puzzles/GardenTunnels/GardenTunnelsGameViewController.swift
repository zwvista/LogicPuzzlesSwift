//
//  GardenTunnelsGameViewController.swift
//  LogicPuzzlesSwift
//
...
class GardenTunnelsGameViewController: GameGameViewController2<GardenTunnelsGameState, GardenTunnelsGame, GardenTunnelsDocument, GardenTunnelsGameScene> {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = GardenTunnelsGameMove(p: p, dir: dir)
    ...
    override func handlePan(_ sender: UIPanGestureRecognizer) {
        ...
        case .changed:
            ...
            var move = GardenTunnelsGameMove(p: pLast!, dir: dir)
    ...
    override func newGame(level: GameLevel) -> GardenTunnelsGame {
        GardenTunnelsGame(layout: level.layout, delegate: self)
    }
}
