...
class KakurasuGame: GridGame<KakurasuGameViewController> {
    static let offset = [
        Position(-1, 0),
        Position(0, 1),
        Position(1, 0),
    ...
    private func changeObject(move: inout KakurasuGameMove, f: (inout KakurasuGameState, inout KakurasuGameMove) -> Bool) -> Bool {
        if canRedo {
