...
class FlowerBedsGameScene: GameScene<FlowerBedsGameState> {
    var gridNode: FlowerBedsGridNode {
        get { getGridNode() as! FlowerBedsGridNode }
    ...
    override func levelInitialized(_ game: AnyObject, state: FlowerBedsGameState, skView: SKView) {
        let game = game as! FlowerBedsGame
        removeAllChildren()
    ...
    override func levelUpdated(from stateFrom: FlowerBedsGameState, to stateTo: FlowerBedsGameState) {
