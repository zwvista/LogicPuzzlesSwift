...
class InsaneTatamisGame: GridGame<InsaneTatamisGameState> {
    ...
    init(layout: [String], delegate: InsaneTatamisGameViewController? = nil) {
        ...
        let state = InsaneTatamisGameState(game: self)
