//
//  ShopAndGasGameViewController.swift
//  LogicPuzzlesSwift
//
...
class ShopAndGasGameViewController: GameGameViewController2<ShopAndGasGameState, ShopAndGasGame, ShopAndGasDocument, ShopAndGasGameScene> {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = ShopAndGasGameMove(p: p, dir: dir)
    ...
    override func newGame(level: GameLevel) -> ShopAndGasGame {
        ShopAndGasGame(layout: level.layout, delegate: self)
    }
}
