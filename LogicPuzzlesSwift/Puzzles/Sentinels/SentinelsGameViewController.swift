//
//  SentinelsGameViewController.swift
//  LogicPuzzlesSwift
//
...
class SentinelsGameViewController: GameGameViewController, GameDelegate, SentinelsMixin {
    ...
    override func viewDidLoad() {
        ...
        scene = SentinelsGameScene(size: skView.bounds.size)
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = SentinelsGameMove(p: p, obj: .empty)
    ...
    func startGame() {
        ...
        game = SentinelsGame(layout: layout, delegate: self)
    ...
    func moveAdded(_ game: AnyObject, move: SentinelsGameMove) {
        guard !levelInitilizing else {return}
        gameDocument.moveAdded(game: game, move: move)
    }
    
    func updateMovesUI(_ game: SentinelsGame) {
    ...
    func levelInitilized(_ game: AnyObject, state: SentinelsGameState) {
        let game = game as! SentinelsGame
        updateMovesUI(game)
        scene.levelInitialized(game, state: state, skView: skView)
    }
    
    func levelUpdated(_ game: AnyObject, from stateFrom: SentinelsGameState, to stateTo: SentinelsGameState) {
        let game = game as! SentinelsGame
        updateMovesUI(game)
        guard !levelInitilizing else {return}
