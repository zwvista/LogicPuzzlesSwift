...
class ProductSentinelsGameViewController: GameViewController, GameDelegate, ProductSentinelsMixin {
    ...
    @IBAction func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = ProductSentinelsGameMove(p: p, obj: .empty)
    ...
    func startGame() {
        ...
        game = ProductSentinelsGame(layout: layout, delegate: self)
    ...
    func moveAdded(_ game: AnyObject, move: ProductSentinelsGameMove) {
        guard !levelInitilizing else {return}
        gameDocument.moveAdded(game: game, move: move)
    }
    
    func updateMovesUI(_ game: ProductSentinelsGame) {
    ...
    func levelInitilized(_ game: AnyObject, state: ProductSentinelsGameState) {
        let game = game as! ProductSentinelsGame
        updateMovesUI(game)
        scene.levelInitialized(game, state: state, skView: skView)
    }
    
    func levelUpdated(_ game: AnyObject, from stateFrom: ProductSentinelsGameState, to stateTo: ProductSentinelsGameState) {
        let game = game as! ProductSentinelsGame
        updateMovesUI(game)
