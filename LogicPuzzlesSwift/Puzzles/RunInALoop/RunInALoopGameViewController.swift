//
//  RunInALoopGameViewController.swift
//  LogicPuzzlesSwift
//
...
class RunInALoopGameViewController: GameGameViewController2<RunInALoopGameState, RunInALoopGame, RunInALoopDocument, RunInALoopGameScene> {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = RunInALoopGameMove(p: p, dir: dir)
    ...
    override func newGame(level: GameLevel) -> RunInALoopGame {
        RunInALoopGame(layout: level.layout, delegate: self)
    }
}
