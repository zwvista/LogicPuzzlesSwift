...
class NeighboursMainViewController: MainViewController, NeighboursMixin {
    ...
    @IBAction func resumGame(_ sender: AnyObject) {
        ...
        let gameViewController = self.storyboard!.instantiateViewController(withIdentifier: "NeighboursGameViewController") as! NeighboursGameViewController
