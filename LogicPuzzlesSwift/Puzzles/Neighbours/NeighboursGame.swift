...
class NeighboursGame: GridGame<NeighboursGameViewController> {
    ...
    init(layout: [String], elemLevel: XMLElement, delegate: NeighboursGameViewController? = nil) {
    ...
    private func changeObject(move: inout NeighboursGameMove, f: (inout NeighboursGameState, inout NeighboursGameMove) -> Bool) -> Bool {
        if canRedo {
