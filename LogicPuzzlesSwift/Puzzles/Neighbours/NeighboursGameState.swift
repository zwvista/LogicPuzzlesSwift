...
class NeighboursGameState: GridGameState<NeighboursGameMove> {
    ...
    override func setObject(move: inout NeighboursGameMove) -> GameOperationType {
        var changed = false
    ...
    override func switchObject(move: inout NeighboursGameMove) -> GameOperationType {
    ...
    */
    private func updateIsSolved() {
        ...
        for area in areas {
            ...
            // 4. Divide the land so that each one has an equal number of squares and
            // the requested number of neighbours.
            pos2state[p3] = n1 == n2 && (n3 == NeighboursGame.PUZ_UNKNOWN || n3 == neighbours()) ? .complete : .error
