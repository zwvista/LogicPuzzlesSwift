...
class BootyIslandGame: GridGame<BootyIslandGameViewController, BootyIslandGameMove, BootyIslandGameState>, GameBase {
    ...
    private func changeObject(move: inout BootyIslandGameMove, f: (inout BootyIslandGameState, inout BootyIslandGameMove) -> Bool) -> Bool {
        if canRedo {
