...
class TataminoGameState: GridGameState<TataminoGameMove> {
    ...
    override func setObject(move: inout TataminoGameMove) -> GameOperationType {
        let p = move.p
    ...
    override func switchObject(move: inout TataminoGameMove) -> GameOperationType {
        let p = move.p
