...
class HolidayIslandGame: GridGame<HolidayIslandGameViewController> {
    static let offset = [
        Position(-1, 0),
        Position(0, 1),
        Position(1, 0),
    ...
    private func changeObject(move: inout HolidayIslandGameMove, f: (inout HolidayIslandGameState, inout HolidayIslandGameMove) -> Bool) -> Bool {
        if canRedo {
