//
//  HolidayIslandGameViewController.swift
//  LogicPuzzlesSwift
//
...
class HolidayIslandGameViewController: GameGameViewController {
    ...
    override func viewDidLoad() {
        ...
        scene = HolidayIslandGameScene(size: skView.bounds.size)
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = HolidayIslandGameMove(p: p, obj: .empty)
    ...
    override func startGame() {
        ...
        game = HolidayIslandGame(layout: level.layout, delegate: self)
    ...
    override func moveAdded(_ game: AnyObject, move: Any) {
        ...
        gameDocument.moveAdded(game: game, move: move as! HolidayIslandGameMove)
    }
    
    override func levelInitilized(_ game: AnyObject, state: AnyObject) {
        let game = game as! HolidayIslandGame
        updateMovesUI(game)
        scene.levelInitialized(game, state: state as! HolidayIslandGameState, skView: skView)
    }
    ...
    override func levelUpdated(_ game: AnyObject, from stateFrom: AnyObject, to stateTo: AnyObject) {
        ...
        updateMovesUI(game)
        guard !levelInitilizing else {return}
        scene.levelUpdated(from: stateFrom as! HolidayIslandGameState, to: stateTo as! HolidayIslandGameState)
