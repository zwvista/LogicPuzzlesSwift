...
class FenceItUpMainViewController: GameMainViewController, FenceItUpMixin {
    ...
    override func resumGame(_ sender: AnyObject) {
        ...
        let gameViewController = self.storyboard!.instantiateViewController(withIdentifier: "FenceItUpGameViewController") as! FenceItUpGameViewController
