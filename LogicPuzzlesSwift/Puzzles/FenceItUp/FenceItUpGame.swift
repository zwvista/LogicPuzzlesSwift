...
class FenceItUpGame: GridGame<FenceItUpGameViewController> {
    static let offset = [
        Position(-1, 0),
        Position(0, 1),
        Position(1, 0),
    ...
    init(layout: [String], elemLevel: XMLElement, delegate: FenceItUpGameViewController? = nil) {
    ...
    private func changeObject(move: inout FenceItUpGameMove, f: (inout FenceItUpGameState, inout FenceItUpGameMove) -> Bool) -> Bool {
        if canRedo {
