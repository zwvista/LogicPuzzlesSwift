...
class WishSandwichGame: GridGame<WishSandwichGameState> {
    ...
    init(layout: [String], delegate: WishSandwichGameViewController? = nil) {
        ...
        let state = WishSandwichGameState(game: self)
