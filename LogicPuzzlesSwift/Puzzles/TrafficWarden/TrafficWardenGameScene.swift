...
class TrafficWardenGameScene: GameScene<TrafficWardenGameState> {
    var gridNode: TrafficWardenGridNode {
        get { getGridNode() as! TrafficWardenGridNode }
