//
//  TrafficWardenGameViewController.swift
//  LogicPuzzlesSwift
//
...
class TrafficWardenGameViewController: GameGameViewController2<TrafficWardenGameState, TrafficWardenGame, TrafficWardenDocument, TrafficWardenGameScene> {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = TrafficWardenGameMove(p: p, dir: dir)
    ...
    override func newGame(level: GameLevel) -> TrafficWardenGame {
        TrafficWardenGame(layout: level.layout, delegate: self)
    }
}
