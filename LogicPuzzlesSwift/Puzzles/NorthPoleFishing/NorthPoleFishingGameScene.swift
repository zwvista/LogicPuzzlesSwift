//
//  NorthPoleFishingGameScene.swift
//  LogicPuzzlesSwift
//
...
class NorthPoleFishingGameScene: GameScene<NorthPoleFishingGameState> {
    ...
    override func levelInitialized(_ game: AnyObject, state: NorthPoleFishingGameState, skView: SKView) {
    ...
    override func levelUpdated(from stateFrom: NorthPoleFishingGameState, to stateTo: NorthPoleFishingGameState) {
