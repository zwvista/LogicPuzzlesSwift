//
//  AbstractMirrorPaintingGameScene.swift
//  LogicPuzzlesSwift
//
...
class AbstractMirrorPaintingGameScene: GameScene<AbstractMirrorPaintingGameState> {
    var gridNode: AbstractMirrorPaintingGridNode {
        get { getGridNode() as! AbstractMirrorPaintingGridNode }
