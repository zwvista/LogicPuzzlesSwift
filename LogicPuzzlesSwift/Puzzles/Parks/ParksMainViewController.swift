...
class ParksMainViewController: MainViewController, ParksMixin {
    ...
    @IBAction func resumGame(_ sender: AnyObject) {
        ...
        let gameViewController = self.storyboard!.instantiateViewController(withIdentifier: "ParksGameViewController") as! ParksGameViewController
