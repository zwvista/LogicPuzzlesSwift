...
class DigitalBattleShipsGameViewController: GameGameViewController, GameDelegate, DigitalBattleShipsMixin {
    ...
    func startGame() {
        ...
        game = DigitalBattleShipsGame(layout: layout, delegate: self)
