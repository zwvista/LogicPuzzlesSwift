//
//  CaffelatteGameViewController.swift
//  LogicPuzzlesSwift
//
...
class CaffelatteGameViewController: GameGameViewController2<CaffelatteGameState, CaffelatteGame, CaffelatteDocument, CaffelatteGameScene> {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = CaffelatteGameMove(p: p, dir: dir)
    ...
    override func newGame(level: GameLevel) -> CaffelatteGame {
        CaffelatteGame(layout: level.layout, delegate: self)
    }
}
