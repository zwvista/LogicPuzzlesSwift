//
//  PathOnTheMountainsGameScene.swift
//  LogicPuzzlesSwift
//
...
class PathOnTheMountainsGameScene: GameScene<PathOnTheMountainsGameState> {
    var gridNode: PathOnTheMountainsGridNode {
        get { getGridNode() as! PathOnTheMountainsGridNode }
        set { setGridNode(gridNode: newValue) }
    }
    
    override func levelInitialized(_ game: AnyObject, state: PathOnTheMountainsGameState, skView: SKView) {
        let game = game as! PathOnTheMountainsGame
        removeAllChildren()
    ...
    override func levelUpdated(from stateFrom: PathOnTheMountainsGameState, to stateTo: PathOnTheMountainsGameState) {
