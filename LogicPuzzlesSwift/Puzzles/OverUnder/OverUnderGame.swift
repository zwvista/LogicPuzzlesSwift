...
class OverUnderGame: GridGame<OverUnderGameViewController> {
    static let offset = [
        Position(-1, 0),
        Position(0, 1),
        Position(1, 0),
    ...
    private func changeObject(move: inout OverUnderGameMove, f: (inout OverUnderGameState, inout OverUnderGameMove) -> Bool) -> Bool {
        if canRedo {
