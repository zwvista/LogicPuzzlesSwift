...
class BoxItAroundGame: GridGame<BoxItAroundGameViewController> {
    static let offset = [
        Position(-1, 0),
        Position(0, 1),
        Position(1, 0),
    ...
    init(layout: [String], elemLevel: XMLElement, delegate: BoxItAroundGameViewController? = nil) {
    ...
    private func changeObject(move: inout BoxItAroundGameMove, f: (inout BoxItAroundGameState, inout BoxItAroundGameMove) -> Bool) -> Bool {
        if canRedo {
