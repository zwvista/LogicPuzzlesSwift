...
class BoxItAgainGameViewController: GameGameViewController {
    ...
    override func startGame() {
        ...
        game = BoxItAgainGame(layout: level.layout, delegate: self)
    ...
    override func moveAdded(_ game: AnyObject, move: Any) {
        ...
        gameDocument.moveAdded(game: game, move: move as! BoxItAgainGameMove)
    }
    
    override func levelInitilized(_ game: AnyObject, state: AnyObject) {
        let game = game as! BoxItAgainGame
        updateMovesUI(game)
        scene.levelInitialized(game, state: state as! BoxItAgainGameState, skView: skView)
    }
    ...
    override func levelUpdated(_ game: AnyObject, from stateFrom: AnyObject, to stateTo: AnyObject) {
        ...
        updateMovesUI(game)
        guard !levelInitilizing else {return}
        scene.levelUpdated(from: stateFrom as! BoxItAgainGameState, to: stateTo as! BoxItAgainGameState)
