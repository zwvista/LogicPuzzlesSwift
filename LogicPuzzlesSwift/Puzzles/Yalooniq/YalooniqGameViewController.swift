//
//  YalooniqGameViewController.swift
//  LogicPuzzlesSwift
//
...
class YalooniqGameViewController: GameGameViewController2<YalooniqGameState, YalooniqGame, YalooniqDocument, YalooniqGameScene> {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = YalooniqGameMove(p: p, dir: dir)
    ...
    override func newGame(level: GameLevel) -> YalooniqGame {
        YalooniqGame(layout: level.layout, delegate: self)
    }
}
