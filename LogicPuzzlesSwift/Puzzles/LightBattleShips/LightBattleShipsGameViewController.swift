//
//  LightBattleShipsGameViewController.swift
//  LogicPuzzlesSwift
//
...
class LightBattleShipsGameViewController: GameGameViewController, GameDelegate, LightBattleShipsMixin {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = LightBattleShipsGameMove(p: p, obj: .empty)
    ...
    func startGame() {
        ...
        game = LightBattleShipsGame(layout: layout, delegate: self)
    ...
    func moveAdded(_ game: AnyObject, move: LightBattleShipsGameMove) {
        guard !levelInitilizing else {return}
        gameDocument.moveAdded(game: game, move: move)
    }
    
    func updateMovesUI(_ game: LightBattleShipsGame) {
    ...
    func levelInitilized(_ game: AnyObject, state: LightBattleShipsGameState) {
        let game = game as! LightBattleShipsGame
        updateMovesUI(game)
        scene.levelInitialized(game, state: state, skView: skView)
    }
    
    func levelUpdated(_ game: AnyObject, from stateFrom: LightBattleShipsGameState, to stateTo: LightBattleShipsGameState) {
        let game = game as! LightBattleShipsGame
        updateMovesUI(game)
        guard !levelInitilizing else {return}
