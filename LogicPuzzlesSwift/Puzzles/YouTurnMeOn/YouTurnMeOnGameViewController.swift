//
//  YouTurnMeOnGameViewController.swift
//  LogicPuzzlesSwift
//
...
class YouTurnMeOnGameViewController: GameGameViewController2<YouTurnMeOnGameState, YouTurnMeOnGame, YouTurnMeOnDocument, YouTurnMeOnGameScene> {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = YouTurnMeOnGameMove(p: p, dir: dir)
    ...
    override func newGame(level: GameLevel) -> YouTurnMeOnGame {
        YouTurnMeOnGame(layout: level.layout, delegate: self)
    }
}
