...
class TapAlikeGame: GridGame<TapAlikeGameViewController> {
    ...
    init(layout: [String], elemLevel: XMLElement, delegate: TapAlikeGameViewController? = nil) {
    ...
    private func changeObject(move: inout TapAlikeGameMove, f: (inout TapAlikeGameState, inout TapAlikeGameMove) -> Bool) -> Bool {
        if canRedo {
