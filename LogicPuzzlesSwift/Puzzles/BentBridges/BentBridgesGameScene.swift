...
class BentBridgesGameScene: GameScene<BentBridgesGameState> {
    ...
    override func levelUpdated(from stateFrom: BentBridgesGameState, to stateTo: BentBridgesGameState) {
        for (p, info) in stateFrom.game.islandsInfo {
            ...
            func addBentBridges(dir: Int, bridges: Int) {
            ...
            func removeBentBridges(dir: Int, bridges: Int) {
                guard bridges > 0 else {return}
            ...
            for dir in [1, 2] {
                if b1[dir] != b2[dir] {
                    removeBentBridges(dir: dir, bridges: b1[dir])
                    addBentBridges(dir: dir, bridges: b2[dir])
                }
            }
        }
    }
