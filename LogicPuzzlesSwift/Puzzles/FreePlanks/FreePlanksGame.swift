...
class FreePlanksGame: GridGame<FreePlanksGameState> {
    ...
    init(layout: [String], delegate: FreePlanksGameViewController? = nil) {
        ...
        let state = FreePlanksGameState(game: self)
