//
//  CultureTripGameViewController.swift
//  LogicPuzzlesSwift
//
...
class CultureTripGameViewController: GameGameViewController2<CultureTripGameState, CultureTripGame, CultureTripDocument, CultureTripGameScene> {
    ...
    override func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        var move = CultureTripGameMove(p: p, dir: dir)
    ...
    override func newGame(level: GameLevel) -> CultureTripGame {
        CultureTripGame(layout: level.layout, delegate: self)
    }
}
