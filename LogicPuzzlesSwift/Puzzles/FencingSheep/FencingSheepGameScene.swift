...
class FencingSheepGameScene: GameScene<FencingSheepGameState> {
    var gridNode: FencingSheepGridNode {
        get { getGridNode() as! FencingSheepGridNode }
    ...
    override func levelUpdated(from stateFrom: FencingSheepGameState, to stateTo: FencingSheepGameState) {
